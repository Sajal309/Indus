...
<button style="position:fixed; opacity:1; bottom:0; left:0; right:0; width:100%; background:rgb(253, 162, 162);padding:10px; border:none;color:white;" name="submit">submit</button>
</form>
